...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "if", "write", "empty", "var", "varlist", "stlist", "$accept", "Anon@1", 
      };
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{25,18,3,4,5,31,11,35,12,40,20,47,4,-12,10,-12},new int[]{-15,5,-6,54,-7,9,-3,10,-8,29,-9,30,-11,34,-13,39,-10,46,-12,53});
    states[5] = new State(new int[]{4,6,10,7});
    states[6] = new State(-24);
    states[7] = new State(new int[]{25,18,3,4,5,31,11,35,12,40,20,47,4,-12,10,-12},new int[]{-6,8,-7,9,-3,10,-8,29,-9,30,-11,34,-13,39,-10,46,-12,53});
    ...
    states[32] = new State(new int[]{13,13,14,23,25,18,3,4,5,31,11,35,12,40,20,47,4,-12,10,-12,22,-12},new int[]{-6,33,-7,9,-3,10,-8,29,-9,30,-11,34,-13,39,-10,46,-12,53});
    ...
    states[41] = new State(new int[]{25,18},new int[]{-14,42,-3,45});
    states[42] = new State(new int[]{19,43,4,-30,10,-30,22,-30});
    states[43] = new State(new int[]{25,18},new int[]{-3,44});
    states[44] = new State(-32);
    states[45] = new State(-31);
    states[46] = new State(-10);
    states[47] = new State(new int[]{25,18,23,19,17,20},new int[]{-2,48,-4,28,-5,27,-3,17});
    states[48] = new State(new int[]{21,49,13,13,14,23});
    states[49] = new State(new int[]{25,18,3,4,5,31,11,35,12,40,20,47,4,-12,10,-12,22,-12},new int[]{-6,50,-7,9,-3,10,-8,29,-9,30,-11,34,-13,39,-10,46,-12,53});
    states[50] = new State(new int[]{22,51,4,-27,10,-27});
    states[51] = new State(new int[]{25,18,3,4,5,31,11,35,12,40,20,47,4,-12,10,-12,22,-12},new int[]{-6,52,-7,9,-3,10,-8,29,-9,30,-11,34,-13,39,-10,46,-12,53});
    ...
    rules[26] = new Rule(-11, new int[]{11,17,-2,18});
    rules[27] = new Rule(-10, new int[]{20,-2,21,-6});
    rules[28] = new Rule(-10, new int[]{20,-2,21,-6,22,-6});
    rules[29] = new Rule(-17, new int[]{});
    rules[30] = new Rule(-13, new int[]{12,-17,-14});
    rules[31] = new Rule(-14, new int[]{-3});
    rules[32] = new Rule(-14, new int[]{-14,19,-3});
  }
